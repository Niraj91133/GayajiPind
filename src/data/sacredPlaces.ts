...
export const SACRED_PLACES: SacredPlace[] = [
  {
    ...
    bengaliName: "বিষ্ণুপদ মন্দির",
    tagline: "The sanctified footprint of Lord Vishnu etched into solid basalt rock",
    bengaliTagline: "ভগবান শ্রী বিষ্ণুর চরণ চিহ্ন খচিত পরম পবিত্র গর্ভগৃহ",
    ...
    bengaliSignificance: "গয়া তীর্থযাত্রার প্রধান কেন্দ্র। ভগবান শ্রী বিষ্ণুর পবিত্র পদপদ্মে পিণ্ডদান করলে একুশ পুরুষের পিতৃপুরুষ বৈকুণ্ঠলোক প্রাপ্ত হন।",
  ...
  },
  {
    ...
    bengaliName: "পবিত্র ফল্গু নদী (অন্তর্বাহিনী)",
    tagline: "The sacred river flowing beneath the sands, blessed by the hands of Mata Sita",
    bengaliTagline: "মাতা সীতার আশীর্বাদধন্য বালির তলায় প্রবাহিত অন্তর্বাহিনী পবিত্র জলধারা",
    ...
    bengaliSignificance: "ত্রেতাযুগে মাতা সীতার আশীর্বাদধন্য এই পবিত্র নদীর বালির নিচেই বয়ে চলে পুণ্যতোয়া জল, যা দিয়ে বালু পিণ্ড ও তর্পণ সম্পন্ন করা হয়।",
  ...
  },
  {
    ...
    hindiName: "अमर अक्षयवट वृक्ष",
    bengaliName: "অমর অক্ষয়বট বৃক্ষ",
    tagline: "The immortal banyan tree where ancestral fulfillment (Suphal) is bestowed",
    bengaliTagline: "পূর্বপুরুষদের চিরন্তন তৃপ্তি ও সুফল প্রাপ্তির অমর বটবৃক্ষ",
    ...
    bengaliSignificance: "মাতা সীতার বরে অমর অক্ষয়বট বৃক্ষতলে তীর্থের অন্তিম পিণ্ডদান ও পুরোহিতদের থেকে 'সুফল' আশীর্বাদ গ্রহণ করা হয়।",
  ...
  },
  {
    ...
    bengaliName: "প্রেতশিলা পর্বত ও ব্রহ্মকুণ্ড",
    tagline: "The elevated mountain sanctuary dedicated to liberating unpacified souls",
    bengaliTagline: "অশান্ত ও অতৃপ্ত আত্মার শান্তির জন্য বিশেষ পবিত্র পর্বত",
    ...
    bengaliSignificance: "গয়ার উত্তরে পাহাড় চূড়ায় অবস্থিত এই স্থানে ছাতু ও তিল পিণ্ডদানে অকালপ্রয়াত এবং অতৃপ্ত আত্মাগণ চিরশান্তি লাভ করেন।",
